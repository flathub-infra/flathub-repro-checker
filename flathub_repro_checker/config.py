...
class Config:
    ...
    @staticmethod
    def diffoscope_output_dir(flatpak_id: str) -> str:
        return os.path.abspath(os.path.join(os.getcwd(), f"diffoscope_result-{flatpak_id}"))

    @staticmethod
    def manifest_save_dir(flatpak_id: str) -> str:
